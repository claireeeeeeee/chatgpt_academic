...
@CatchException
def code_generation_human(txt, llm_kwargs, plugin_kwargs, chatbot, history, system_prompt, web_port):
    """
    ...
    for entry in jsonl_data:
        ...
        save_history(task_id, 'Project Leader for Developer: ', plan_say)
        save_history(task_id, 'Project Leader for Testers: ', tester_say)
        ...
        save_history(task_id, 'Final code:', gpt_say)
...
def save_to_jsonl(task_id, code_segments):
    ...
    with open("/home/cli776/human-eval/samples_human.jsonl", "a") as file:
        file.write(json.dumps(data) + "\n")
    
def save_history(key1, key2, plan_say):
    filename="/home/cli776/human-eval/recoding_human.jsonl"
